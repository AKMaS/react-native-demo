...
// 收藏
export const COLLECT_BOOK_DOING = 'COLLECT_BOOK_DOING';
export const COLLECT_BOOK_SUCCEED = 'COLLECT_BOOK_SUCCEED';
export const COLLECT_BOOK_ERROR = 'COLLECT_BOOK_ERROR';